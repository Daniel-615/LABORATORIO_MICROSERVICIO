...
class Connection:
    def __init__(self):
        self.user_sql_server = os.getenv("DB_USER_SQL_SERVER", "root")
        self.password_sql_server = os.getenv("DB_PASSWORD_SQL_SERVER", "angel1234")
        self.database_sql_server = os.getenv("DB_NAME_SQL_SERVER", "certificado_factura")
    ...
    def connect_sqlserver(self):
        try:
            connection_url = (
                ...
                f"MSI\\SQLEXPRESS2022/{self.database_sql_server}"
